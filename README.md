...
## One'd Technologies
One'd Technologies was founded with the theme of creating an environment and tools that allow all "creators" to focus more on their creative activities. Currently, we are developing and providing DEXTRE, a global B2B EC/Back Office/Product Master SaaS, aiming to be a user-defined cloud ERP in the manufacturing and sales fields. We are developing several other products in parallel, and are working to build a global ecosystem that can manage global/local transactions and master "liquid assets" in both directions with high flexibility, in conjunction with B2B/B2C malls under development.
